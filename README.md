...
- During this development, I realized that using [SwiftSyntax](https://github.com/apple/swift-syntax) was more suitable for in-depth analysis using Abstract Syntax Tree. Therefore, I made [swift-dependency-analyzer](https://github.com/yoching/swift-dependency-analyzer) using SwiftSyntax.
